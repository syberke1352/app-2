...
import { Calendar, CircleCheck as CheckCircle, Clock, FileAudio, User, Circle as XCircle } from 'lucide-react-native';
        ...
        <ScrollView style={styles.penilaianContent}>
          ...
          <View style={styles.audioSection}>
            ...
            <AudioPlayer 
              ...
              title={`${selectedSetoran.jenis === 'hafalan' ? 'Hafalan' : 'Murojaah'} ${selectedSetoran.surah} - ${selectedSetoran.siswa.name}`}
              autoPlay={false}
            />
          </View>
