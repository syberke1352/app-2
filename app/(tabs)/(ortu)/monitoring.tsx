...
import { User, TrendingUp, BookOpen, Award, Calendar, Target, XCircle, Clock, CircleCheck as CheckCircle, Search, BarChart3 } from 'lucide-react-native';
      ...
      <View style={styles.overallStatsContainer}>
        ...
        <View style={styles.overallStats}>
          ...
          <View style={styles.overallStatCard}>
            ...
            <Text style={styles.overallStatNumber}>
              {children.reduce((sum, child) => sum + child.labelCount, 0)}
            </Text>
            <Text style={styles.overallStatLabel}>Total Label</Text>
          </View>
        </View>
      </View>
